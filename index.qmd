...
**R for Plant Disease Epidemiology** (R4PDE) is a dynamic online book (with [ePub](R4PDE.net.epub) and [Docx](R4PDE.net.docx) versions) rooted in the teachings of the annual graduate course, FIP 602 - Plant Disease Epidemiology, a key part of the curriculum in the [Graduate Program in Plant Pathology](http://www.dfp.ufv.br/grad/) at Universidade Federal de Viçosa.
