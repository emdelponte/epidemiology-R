...
```{r}
#| label: fig-anima
#| fig-cap: "The spatial patterns of plant disease epidemcs: random, aggreated and regular"
#| warning: false
#| message: false
#| eval: false
rand <- dat |> 
...
![Spatial patterns for the incidence of spotted wilt virus assessed during six times during the epidemics](imgs/spatiotemporal.gif){#fig-spatiotemporal2 width="685"}
