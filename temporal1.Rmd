...
description: |
  Get to know the most popular deterministic models of continuous time that are commonly fitted to disease progress curve data. 
author:
...
Following the convention proposed by [@chapter2017f] in their book "The study of plant disease epidemics":
