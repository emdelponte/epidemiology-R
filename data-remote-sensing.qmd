...
```{r}
#| include: false
if (!file.exists("data/banana_data/1_UAV multispectral reflectance/UAV multispectral reflectance.tif")) {
...
```{r}
#| eval: true
# Re-enable execution for the Cercospora leaf spot section
