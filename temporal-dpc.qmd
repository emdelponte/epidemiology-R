...
```{r}
#| label: fig-dpc
#| fig-cap: "A typical disease progress curve for an epidemic that reaches the maximum value" 
dpc |>
  ggplot(aes(t, y)) +
  geom_line(size = 1)+
...
```{r}
#| label: fig-audpc1
#| fig-cap: "Representation of the area under the disease progress curve" 
#| warning: false
#| message: false
...
```{r}
#| label: fig-audpc2
#| fig-cap: "Representation of the area under the disease progress curve calculated using the trapezoidal method" 
