...
Set the parameters for the gradient.
...
Visualize the two gradient models with two parameters.
...
```{r}
plot(Y ~ x, data=grad1, main="", type=c("o"), ylab="Lesion count", xlab="Distance (m)")
