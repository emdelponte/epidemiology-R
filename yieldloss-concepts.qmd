...
Yield loss studies are only possible when reliable field data are collected in sufficient number to allow the development of statistical models (that summarizes the relationship) as well as the validation of mechanistic simulation models. Whenever established, knowledge of the empirical disease:yield relationship and of the theoretical basis of damage on crops, can further be used for several purposes such as: 1) determine the effect of control on crop yield; 2) make prediction of yield in given location or region; and 3) determine the economic importance of diseases.
