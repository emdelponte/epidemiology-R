...
The family of models that describe the growth of epidemics, hence population dynamics model, are known as deterministic models of continuous time [@chapter2017e]. These models are empirically derived, meaning that they come from their fit to disease progress curve data.
