...
The family of models that describe the growth of epidemics, hence population dynamics model, are known as deterministic models of continuous time @chapter2017b. These are the models that are usually fitted to disease progress curve data to obtain two or more biologically meaningful parameters.
