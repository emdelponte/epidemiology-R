...
```{r}
## Define the temperature response function
...
applescab <- ggplot(temperature_data, aes(x = Temperature, y = Wetness_Duration)) +
...
soyrust <- ggplot(temperature_data, aes(x = Temperature, y = Wetness_Duration)) +
  geom_line(color = "black", linewidth = 1, linetype =1) +
  theme_r4pde(font_size = 14)+
  labs(x = "Temperature (°C)", y = "Wetness Duration (hours)", 
