...
-   Intercept: Estimate of -17.86, indicating the baseline log-odds of an epidemic when all predictors are zero.
...
confusionMatrix(data = as.factor(as.numeric(pred_probs > 0.5)),  mode= "everything",  reference = as.factor(epi_weather$epidemic))
```
