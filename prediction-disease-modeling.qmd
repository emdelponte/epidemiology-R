...
We will fit the equation proposed by @bernard2013 which predicts a thermal response curve, which is the relationship between the inverse of latent period and temperature. We need to enter the values for optimum temperature (where latent period is shortest) and the shortest latent period.
