...
The SADs, also known as diagrammatic scales, are a set of diagrams which have long use in plant pathology. The tool dates back to the late 1800s, when the Cobb scale was developed with five diagrams illustrating a range of severity values of rust pustules on wheat leaves. SADs have been designed in various color types (black or white, two-color or true-color) and and incremental scales (approximated linear or logarithmic) [@delponte2017]. Follows examples of SADs in black and white and true-color:
...
[![SADBank, a curated collection of articles](imgs/sadbank.png){#fig-sadbank width="595" height="362"}](https://emdelponte.github.io/sadbank/)
