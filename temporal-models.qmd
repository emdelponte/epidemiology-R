...
A shiny app was developed to demonstrate these three models interactively. Click on the image below to get access to the app.

[![](imgs/epidemic_models.png)](https://edelponte.shinyapps.io/epidemics/)
