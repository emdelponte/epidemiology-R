...
[![Preparation of image palettes by manually sampling fraction of the images that represent background, heatlhy leaf and lesions](imgs/pliman1.png){fig-align="center"}](Fig_palettes)
...
[![Images created by pliman and exported to a specific folder](imgs/pliman2.png)](fig_folder)

Let's have a look at one of the processed images.

[![Figure created by pliman after batch processing to segment the images and calculate percent area covered by symptoms. The symptomatic area is delinated in the image.](imgs/processed/proc_img46.jpg){width="452"}](fig_proc1)
